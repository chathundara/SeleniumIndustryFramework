...
public class TestListeners extends BaseTest implements ITestListener {
	...
	// Threadlocal is like a map. particular thread can access its own wrapped
	// object only
	 ...
	 * method is called. -- each test class start
	 * 
	 * @param context
	 */
	 ...
	 * been called. -- All test classes finished
	 * 
	 * @param context
	 */
	...
	public void onTestFailure(ITestResult result) {
		...
		//ScreenShot attachment when failed
		String browser = WebDriverFactory.getInstance().getBrowser();//getInstance() singleton instance
		...
		//ScreenShot attachment finished
