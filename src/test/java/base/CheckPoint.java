...
public class CheckPoint {
	...
	/**
	 * Keeps the verification point status with testName, Result and Verification
	 * Point Message in hash map
	 *
	...
	/**
	 * Keeps the verification point status with testName, Result and Verification
	 * Point Message in hash map It asserts all the verifications in a test method,
	 * if any verification in a test method is failed then the test case is failed
	 *
	 * @param testName      - The test case name
	 * @param result        - Verification Result from test method
	 * @param resultMessage - Message tagged with verification
	...
	public static void markFinal(String testName, boolean result, String resultMessage) {
		...
		for (String key : resultMap.keySet()) {
			resultList.add(resultMap.get(key));
				...
				// If any one FAIL found in the resultList, method assert will be failed
