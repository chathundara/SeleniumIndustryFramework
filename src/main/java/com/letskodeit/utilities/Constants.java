...
public class Constants {
    ...
    public static final String DEFAULT_LOGIN="chathundara.krd88@gmail.com";
    public static final String DEFAULT_PASSWORD="0okm)OKM";
    public static final String EXCEL_FILE=USER_DIRECTORY+"//testdata//ExcelTestData.xlsx";
